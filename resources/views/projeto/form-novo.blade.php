                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            {{ Form::text('name_user', Auth::user()->name, ['class' => 'form-control', 'id' => 'prof', 'aria-required' =>'true', 'disabled' => true]) }}
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label class="upper" for="prof_email">E-mail</label>
                            {{ Form::email('email', Auth::user()->email, ['class' => 'form-control', 'id' => 'prof_email', 'aria-required' =>'true', 'disabled' => true]) }}
                        </div>
                    </div>
                </div>
